...
const resources = {
  ...
  pt: {
    translation: {
      ...
      "sort_by": "Ordenar Por",
      "no_evaluations": "Nenhuma avaliação encontrada",
      ...
      "cancel": "Cancelar",
      "confirm_delete": "Tem certeza de que deseja eliminar esta lição? Esta ação não pode ser desfeita.",
      ...
      "confirm_delete_form": "Tem certeza de que deseja eliminar esta turma? Esta ação não pode ser desfeita.",
      "delete": "Eliminar",
      ...
      "confirm_delete_theme": "Tem a certeza que deseja eliminar este tema? Esta ação não pode ser desfeita.",
